    ...
    if ((Test-Path $targetProject) -and (Test-Path $sourceWf)) {
        ...
        foreach ($wfDir in $wfDirs) {
            ...
            if (Test-Path $gitignore) {
                ...
                foreach ($pattern in @("$wfDir/", "/omnistate-dashboard.html", "project-summary.md", "tasks-history.json", "tasks-archive.json", "antigravity.config.json", "chunks/", "AGENTS.md", "AI_POLICY.md", "CONTEXT.md", ".kilo/", ".omnistate/", ".roo/")) {
